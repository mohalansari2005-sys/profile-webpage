 ...
 *
 * Every `tools` entry must match a `Tool.id` below — that link is what the
 * tool strip joins on. Add a tool here before referencing it in a record.
 */
...
export const experience: WorkRecord[] = [
  {
    ...
    summary:
      "Built and integrated Python backend services and REST APIs for a B2B product, and prototyped new product capabilities from requirements through to working software.",
    tools: [
      "python",
      "javascript",
      "rest-apis",
  ...
  },
  {
    ...
    period: "Feb — Apr 2025",
    summary:
      "Ran client meetings, prepared sales pitches, presented proposals, and managed ongoing client relationships. It taught me to read what a client actually needs and present a practical solution — the other half of the problem-solving process from the engineering side.",
    tools: [],
  },
];
...
export const projects: WorkRecord[] = [
  {
    ...
    period: "2026",
    summary:
      "A FastAPI service that turns bulk employee trip requests into booked hotels — Amadeus search, bulk booking through Celery workers, and confirmation emails. I built the core flows solo: multi-tenant, idempotent, with retry and backoff around a rate-limited external API. Shelved before launch when industry regulations changed.",
    tools: [
      "python",
      "fastapi",
      "sqlalchemy",
