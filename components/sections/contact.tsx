...
const links = [
  {
    ...
    icon: (
      ...
      >
        <path d="M1.5 5.25A2.25 2.25 0 0 1 3.75 3h16.5a2.25 2.25 0 0 1 2.25 2.25v.383L12 11.933 1.5 5.633V5.25Z" />
        <path d="M22.5 7.383V18.75A2.25 2.25 0 0 1 20.25 21H3.75A2.25 2.25 0 0 1 1.5 18.75V7.383L12 13.45l10.5-6.067Z" />
      </svg>
    ),
  },
  {
